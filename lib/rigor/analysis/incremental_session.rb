...
module Rigor
  module Analysis
    ...
    class IncrementalSession # rubocop:disable Metrics/ClassLength
      ...
      #
      # The argument is `Runner#per_file_diagnostics` — what `PoolCoordinator#analyze_files` returned —
      # never the run's full stream. Every run-level row is regenerated by every run and must not be served
