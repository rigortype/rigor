...
- **Migrated so far (12 of 30):** the full Rails core — `rigor-activerecord` (rich template, commit `22900dac`; fix `5ace10bd`), `rigor-rails-routes` (`9e9fa052`), `rigor-rails-i18n` (`d4d16ef1`), `rigor-actionpack` (`094b8d0e`), `rigor-activestorage` (`5c725e78`), `rigor-activejob` (`3df0af7c`), `rigor-actionmailer` + `rigor-factorybot` + `rigor-rails` (require-aggregator framing) (`aba3d882`) — plus `rigor-rspec` (`66226ee1`), `rigor-sorbet` (handbook-pointer, `7d64f493`), and `rigor-dry-types` (no-diagnostics fact foundation, `aba3d882`).
