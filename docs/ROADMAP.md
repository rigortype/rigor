...
- **LSP — extended capabilities** (out-of-scope for v1 per design doc): `textDocument/completion`, `textDocument/codeAction`, `textDocument/rename`, `textDocument/semanticTokens`, `textDocument/inlayHint`, multi-root workspaces, TCP / Unix-socket transport. Each is its own design; queued behind concrete editor-integration demand.
