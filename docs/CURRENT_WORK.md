...
Read [ADR-10](adr/10-dependency-source-inference.md) § "Implementation slicing" for the binding slice list. With Slices 1, 2a, 2b-i, and 2b-ii landed (Slice 2 envelope complete), recommended entry order for the next session:
