# Changelog — 0.2.x archive

Archived release notes for the `0.2.x` development cycle — the evaluation
trial opened by `v0.2.0`, the first publicly-announced release.

The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/),
and the project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

This file is the static archive for `0.2.0` through `0.2.9`, moved out of
the main [`CHANGELOG.md`](../CHANGELOG.md) per the project's archival rule:
**at the first release after a minor bump (here `0.3.1`, the first release
after the `0.2.x` → `0.3.x` bump), the entire previous-minor range moves
