...
SPEC_ANALYZER_GUARD_ALLOWLIST = {
  "spec/rigor/analysis/worker_session_spec.rb" => {
    493 => "the buffer half of the pair below: `target_ruby: \"3.0\"` is version-shaped but older than " \
    ...
    598 => "the non-buffer twin, pinning the whole rescue envelope (path, line, column, severity, " \
