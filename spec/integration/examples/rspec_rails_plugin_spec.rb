...
# Integration spec for `examples/rigor-rspec-rails/`.
...
RSPEC_RAILS_PLUGIN_LIB = File.expand_path("../../../examples/rigor-rspec-rails/lib", __dir__)
$LOAD_PATH.unshift(RSPEC_RAILS_PLUGIN_LIB) unless $LOAD_PATH.include?(RSPEC_RAILS_PLUGIN_LIB)
require "rigor-rspec-rails"

RSpec.describe "examples/rigor-rspec-rails" do
