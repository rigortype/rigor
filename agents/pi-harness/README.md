...
| lane | `opencode/deepseek-v4.1-flash` | `opencode/*deepseek*flash*`, `opencode-go/*deepseek*flash*`, `*deepseek*flash*` |
...
- Lane model default is `opencode/deepseek-v4.1-flash`; reviewer prefers
...
| OpenCode | OpenCode / OpenCode Go auth | lane Flash-class (`opencode/deepseek-v4.1-flash`) |
...
| `rigor-lane` / `/lane` | DeepSeek Flash | `opencode/deepseek-v4.1-flash` | Parallel imitation under fixed LaneInput; failure is local | Self-promoting to Opus mid-lane |
