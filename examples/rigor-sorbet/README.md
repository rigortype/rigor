...
This is **slices 1 + 2 + 3 + 4 of [ADR-11](../../docs/adr/11-sorbet-input-adapter.md)**.
Later slices honour `# typed:` sigils + finalise dispatcher
tier ordering (slice 5), and wire `T.absurd` into
