...
- **Migrated so far (8 of 30):** `rigor-activerecord` (rich template, commit `22900dac`; stale-limitation fix `5ace10bd`), `rigor-rspec` (`66226ee1`), `rigor-sorbet` (handbook-pointer style, `7d64f493`), `rigor-rails-routes` (`9e9fa052`), `rigor-rails-i18n` (`d4d16ef1`), `rigor-actionpack` (`094b8d0e`), `rigor-activestorage` (`5c725e78`), `rigor-activejob` (`3df0af7c`).
