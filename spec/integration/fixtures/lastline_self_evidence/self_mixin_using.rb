...
# Issue #1415 — `using` refines `Kernel#gets` with a Ruby method for the rest of the file, so no implicit-self reader in
# it narrows `$_`. Run with `read` as the first argument and "a\nb\n" on standard input; each case cites what Ruby 4.0.5
# answers.
