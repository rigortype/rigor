...
# Integration spec for `examples/rigor-minitest/`.
...
MINITEST_PLUGIN_LIB = File.expand_path("../../../examples/rigor-minitest/lib", __dir__)
$LOAD_PATH.unshift(MINITEST_PLUGIN_LIB) unless $LOAD_PATH.include?(MINITEST_PLUGIN_LIB)
require "rigor-minitest"

RSpec.describe "examples/rigor-minitest" do
