...
# Integration spec for `examples/rigor-shoulda-matchers/`.
...
SHOULDA_PLUGIN_LIB = File.expand_path("../../../examples/rigor-shoulda-matchers/lib", __dir__)
$LOAD_PATH.unshift(SHOULDA_PLUGIN_LIB) unless $LOAD_PATH.include?(SHOULDA_PLUGIN_LIB)
require "rigor-shoulda-matchers"

RSpec.describe "examples/rigor-shoulda-matchers" do
