...
| `literal-string` | String known to come from source literals and literal-only composition. v0.0.10 tracks the carrier through string interpolation `"#{...}"`; propagation through `+` / `<<` is deferred. | `String` |
