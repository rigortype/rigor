...
- **Migrated so far (5 of 30):** `rigor-activerecord` (rich template, commit `22900dac`; stale-limitation fix `5ace10bd`), `rigor-rspec` (`66226ee1`), `rigor-sorbet` (handbook-pointer style, `7d64f493`), `rigor-rails-routes` (`9e9fa052`), `rigor-rails-i18n` (`d4d16ef1`).
