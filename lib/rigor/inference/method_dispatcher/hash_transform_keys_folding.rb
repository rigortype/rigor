...
module Rigor
  module Inference
    module MethodDispatcher
      ...
      # -> Hash[K2, V]`, and {RbsDispatch} binds `K2` to the block return made gradual: it binds an argument
      # position only when the parameter is a bare type variable, so the mapping's values drop out of the key. The
