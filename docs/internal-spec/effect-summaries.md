...
- a `define_method` or `attr_*` where `self` is not a class, such as an instance method or the top level, which raises unless that object is a module.
