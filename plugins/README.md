...
| Plugin | Tier | What it checks | I/O | Cache |
| --- | --- | --- | --- | --- |
| [`rigor-activerecord`](rigor-activerecord/) | 2 | DSL interpretation + multi-file IoBoundary + chained cache producers + two-pass discover-then-validate; **publishes `:model_index` as an ADR-9 fact** (associations / enums / scopes / validations / callbacks / macro methods) | Ruby (`db/schema.rb` + `app/models/`) | ✅ ✅ |
