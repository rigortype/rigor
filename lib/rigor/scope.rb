  ...
  class Scope
    ...
    def with_global(name, type)
      rebuild(globals: @globals.merge(name.to_sym => type).freeze,
              ...
              guard_records: drop_guard_record(:global, name.to_sym))
    end
    ...
    # Issue #1429 — the constant reference `key` with no narrowing: a write to the constant.
    ...
    def same_marks?(other)
      @declaration_sourced == other.declaration_sourced &&
        ...
        @constant_narrowings == other.constant_narrowings &&
        @guard_records == other.guard_records
    end
